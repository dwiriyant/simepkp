                ...
                <div class="card-body">
                    <div class="tab-content p-0">
                        <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                            ...
                            <canvas id="revenue-chart-canvas" height="300" style="height: 300px; display: block; width: 805px;" width="805" class="chartjs-render-monitor"></canvas>
                        </div>
        ...
        <section class="col-lg-5 connectedSortable ui-sortable">
            <div class="card bg-gradient-primary">
                ...
                <div class="card-body">
                    <div id="world-map" style="height: 250px; width: 100%; position: relative; overflow: hidden; background-color: transparent;">
                        <svg width="805" height="250">
                            <g transform="scale(0.42158516020236086) translate(475.2300000000001, 0)">
            ...
            <div class="card bg-gradient-info">
                ...
                <div class="card-body">
                    ...
                    <canvas class="chart chartjs-render-monitor" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 805px;" width="805" height="250"></canvas>
                </div>
                <div class="card-footer bg-transparent">
                    <div class="row">
                        <div class="col-4 text-center">
                                            ...
                                            <table class="table table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="picker-switch" data-action="pickerSwitch" colspan="5" title="Select Month">March 2022</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="02/27/2022" class="day old weekend">27</td>
                                                        ...
                                                        <td data-action="selectDay" data-day="03/04/2022" class="day">4</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-action="selectDay" data-day="03/12/2022" class="day weekend">12</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/13/2022" class="day weekend">13</td>
                                                        <td data-action="selectDay" data-day="03/14/2022" class="day">14</td>
                                                        <td data-action="selectDay" data-day="03/15/2022" class="day">15</td>
                                                        <td data-action="selectDay" data-day="03/16/2022" class="day active today">16</td>
                                                        <td data-action="selectDay" data-day="03/17/2022" class="day">17</td>
                                                        <td data-action="selectDay" data-day="03/18/2022" class="day">18</td>
                                                        <td data-action="selectDay" data-day="03/19/2022" class="day weekend">19</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/20/2022" class="day weekend">20</td>
                                                        ...
                                                        <td data-action="selectDay" data-day="03/26/2022" class="day weekend">26</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="03/27/2022" class="day weekend">27</td>
                                                        ...
                                                        <td data-action="selectDay" data-day="04/02/2022" class="day new weekend">2</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="04/03/2022" class="day new weekend">3</td>
                                                        ...
                                                        <td data-action="selectDay" data-day="04/09/2022" class="day new weekend">9</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
