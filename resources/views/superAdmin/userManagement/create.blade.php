...
@section('content')
    <div class="card card-secondary">
        ...
        <form action="{{ route(Auth::user()->Role->code.'.user-management.store') }}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <x-adminlte-select name="role_id" label="Role" data-placeholder="Pilih Role" required enable-old-support>
                                <x-adminlte-options :options="$roles->pluck('name', 'id')->toArray()"/>
                            </x-adminlte-select>
                        </div>
                        ...
                        <div class="form-group">
                            <x-adminlte-input label="Email" name="email" type="email" required enable-old-support />
                        </div>
                        <div class="form-group">
